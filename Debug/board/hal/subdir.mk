...
C_SRCS += \
../board/hal/hal_frdmmcxn947.c 

C_DEPS += \
./board/hal/hal_frdmmcxn947.d 

OBJS += \
./board/hal/hal_frdmmcxn947.o 


# Each subdirectory must supply rules for building sources it contributes
board/hal/%.o: ../board/hal/%.c board/hal/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-board-2f-hal

clean-board-2f-hal:
	-$(RM) ./board/hal/hal_frdmmcxn947.d ./board/hal/hal_frdmmcxn947.o

.PHONY: clean-board-2f-hal
