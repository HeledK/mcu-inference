...
utilities/%.o: ../utilities/%.S utilities/subdir.mk
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -D__NEWLIB__ -I"C:\UTAR stuf\Y2S3\FYP 1\Exercises for acclimatization\Lab5 Project files\source" -I"C:\UTAR stuf\Y2S3\FYP 1\Exercises for acclimatization\Lab5 Project files\freertos\freertos-kernel\include" -g3 -gdwarf-4 -mcpu=cortex-m33 -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -D__NEWLIB__ -specs=nano.specs -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
