...
CPP_SRCS += \
../eiq/mpp/hal/tflite/model.cpp \
../eiq/mpp/hal/tflite/model_all_ops_micro.cpp 

CPP_DEPS += \
./eiq/mpp/hal/tflite/model.d \
./eiq/mpp/hal/tflite/model_all_ops_micro.d 

OBJS += \
./eiq/mpp/hal/tflite/model.o \
./eiq/mpp/hal/tflite/model_all_ops_micro.o 


# Each subdirectory must supply rules for building sources it contributes
eiq/mpp/hal/tflite/%.o: ../eiq/mpp/hal/tflite/%.cpp eiq/mpp/hal/tflite/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-eiq-2f-mpp-2f-hal-2f-tflite

clean-eiq-2f-mpp-2f-hal-2f-tflite:
	-$(RM) ./eiq/mpp/hal/tflite/model.d ./eiq/mpp/hal/tflite/model.o ./eiq/mpp/hal/tflite/model_all_ops_micro.d ./eiq/mpp/hal/tflite/model_all_ops_micro.o

.PHONY: clean-eiq-2f-mpp-2f-hal-2f-tflite
